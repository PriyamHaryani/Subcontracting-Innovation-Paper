...
df <- read_excel("Me Mario/Papers/Subcontracting & Innovation/Data 2/Data_11012023.xlsx",
    sheet = "Sheet3")
# The data uploaded has only one sheet.
...
panelResult <- censReg( RI ~ SI + PI + Net.sales , data = pnl, method = "BHHH" )
