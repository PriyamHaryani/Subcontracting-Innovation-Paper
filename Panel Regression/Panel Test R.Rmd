...
I##Including a categorical variable as a predictor in a regression model allows for estimating the effect of different levels of the categorical variable on the outcome variable. In this case, including factor(Year) in the formula allows 

grun.fe3 <- plm(Ri ~ Si + factor(Year), data = pnl, model = "within")
summary(grun.fe3) 
